...
/**
 * This class contains all of the warehouse ID related methods.
 * 
 * @author Todd Foreman
 *
 */
...
public class WarehouseServlet extends HttpServlet
{
	...
	URLParserService urlService = new URLParserService();
		...
		/**
		 * Retrieves all of the items within a warehouse based on their warehouse ID.
		 */
		@Override
		...
		/**
		 * Updates the warehouse ID of an item on the database based on JSON received.
		 */
		@Override
